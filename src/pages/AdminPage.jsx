      ...
      <div className="lg:w-[70%] md:w-[90%] sm:w-[90%] w-[100%] m-auto bg-[rgb(34,34,34)] mt-[5%]">
        ...
        <div className="flex flex-col p-5 gap-3">
          <div className="flex flex-col text-white">
            <h1 className="bg-[rgb(145,63,226)] p-2 rounded-sm">
              Upload Image:{" "}
            </h1>
          ...
          <div className="flex flex-col text-white">
            ...
            <div className="w-[90%] self-center flex flex-row items-center gap-5 m-5">
              ...
              <input
                ...
                className="rounded-sm text-black p-1 ml-5 md:w-[18.5%] w-[50%] outline-none"
                type="text"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col text-white">
            ...
            <div className="w-[90%] self-center flex flex-row items-center gap-5 m-5">
              ...
              <input
                ...
                className="rounded-sm text-black ml-5 md:w-[50%] w-[90%] p-5 outline-none"
                type="text"
              />
            </div>
          </div>
        ...
        <div className="w-[100%] gap-5 m-5">
          <button
            onClick={dataSubmit}
            className="bg-[rgb(59,89,153)] mb-5 active:bg-[rgb(38,55,92)] hover:bg-[rgb(51,69,104)] text-white w-[40%] p-2 rounded-sm"
          >
            Add Book
          </button>
        </div>
