  ...
  useEffect(() => {
    const getBookData = async () => {
      const data = await axios.get(
        `https://book-store-u2sc.onrender.com/api/v1/books/${bookId}`
      );
        ...
        <div className="flex flex-col text-white">
          ...
          <div className="w-[90%] self-center flex flex-row items-center gap-5 m-5">
            <button
              ...
              className="bg-[rgb(59,89,153)] active:bg-[rgb(38,55,92)] hover:bg-[rgb(51,69,104)] w-[40%] p-2 rounded-sm"
            >
              Change
            </button>
          </div>
        ...
        <div className="flex flex-col text-white">
          ...
          <div className="w-[90%] self-center flex flex-row items-center gap-5 m-5">
            ...
            <input
              ...
              className="rounded-sm text-black p-1 ml-5 w-[18.5%] outline-none"
              type="text"
            />
          </div>
          <div className="w-[90%] self-center flex flex-row items-center gap-5 m-5">
